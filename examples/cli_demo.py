...
Or:
    cd examples && python cli_demo.py
"""
...
def main() -> None:
    ...
    # Prereq:
    #   pip install -e ".[vertex]"  (or pip install react-usc[vertex])
    ...
    config = AgentConfig(
        ...
        selection_strategy=os.getenv("SELECTION_STRATEGY", "select_one"),  # type: ignore  # or "synthesize_one"
